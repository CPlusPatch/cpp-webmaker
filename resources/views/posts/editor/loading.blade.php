<x-editor-layout>
	...
	<div class="flex items-center justify-center grow">
		<svg width="110" height="160" viewBox="0 0 55 80" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="text-blue-800 animate-bounce">
	...
	<script>
		$(() => {
			...
			.catch((err) => {
				console.error(err);
				snackbar("An error occured. Please try again later.")
			});
		});
	</script>
</x-editor-layout>